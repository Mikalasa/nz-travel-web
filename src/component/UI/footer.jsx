        ...
        <footer aria-label="Site Footer" className="bg-white">
            <div className="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
                <div className="lg:flex lg:items-start lg:gap-8">
                    <div
                        className="mt-8 grid grid-cols-2 gap-8 lg:mt-0 lg:grid-cols-4 lg:gap-y-8"
                    >
                        <div className="col-span-2">
                            <div>
                                ...
                                <p className="mt-4 text-gray-500">
                                    Welcome everyone to subscribe to our website and receive the latest news and exciting content! Please enter your email address beside.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="col-span-2 sm:col-span-1">
                            ...
                            <nav aria-label="Footer Navigation - Contact" className="mt-6">
                                <ul className="space-y-4 text-sm">
                                    <li>
                                        <a href="#" className="text-gray-700 transition hover:opacity-75">
                                            Email us
                        ...
                        <div className="col-span-2 sm:col-span-1">
                            ...
                            <nav aria-label="Footer Navigation - Links" className="mt-6">
                                <ul className="space-y-4 text-sm">
                                    <li>
                                        <a href="#" className="text-gray-700 transition hover:opacity-75">
